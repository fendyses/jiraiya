...
const SAKURA_SVG='<svg width="11" height="11" viewBox="0 0 24 24" fill="none"><g fill="#FF9EC4" opacity=".9">'
  ...
  +'<ellipse cx="12" cy="6.5" rx="3.1" ry="4.2" transform="rotate(144 12 12)"/>'
  +'<ellipse cx="12" cy="6.5" rx="3.1" ry="4.2" transform="rotate(216 12 12)"/>'
  +'<ellipse cx="12" cy="6.5" rx="3.1" ry="4.2" transform="rotate(288 12 12)"/>'
  +'</g><circle cx="12" cy="12" r="1.8" fill="#FFD9E8"/></svg>';
