...
A graceful session-close experience. When Ses says goodbye, JIRAIYA auto-saves session context, optionally nudges open reminders, then displays the **JIRAIYA Farewell Banner** — a framed violet-gradient wordmark — before signing off warmly.
...
- **Farewell Banner** — framed violet-gradient wordmark generated by `banner.sh`
