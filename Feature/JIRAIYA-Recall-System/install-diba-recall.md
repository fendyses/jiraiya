# 🔍 JIRAIYA Recall System — Installation Guide
...
```
Feature/JIRAIYA-Recall-System/
├── README.md
├── SKILL.md
└── install-JIRAIYA-recall.md
```

If you have a `skills/` folder:
- Copy `SKILL.md` → `skills/JIRAIYA-recall.md`
...
```markdown
## Active Features
- 🔍 JIRAIYA Recall System — on-demand workspace recall with session state and reminders
```
...
- **JIRAIYA Recall** → runs on demand, goes deeper into workspace and project context
