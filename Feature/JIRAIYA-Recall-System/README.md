...
| System | Enhancement |
|--------|-------------|
| **Session-Briefing-System** | Session brief owns the startup brief; JIRAIYA Recall is for on-demand or deep recall |
...
See `install-JIRAIYA-recall.md` for setup steps.
