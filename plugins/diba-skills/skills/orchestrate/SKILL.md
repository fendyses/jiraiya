...
Skill ini membantu **JIRAIYA** bertindak sebagai **orchestrator** untuk tugasan kompleks: merancang, memecahkan kerja, memilih corak workflow yang sesuai, menyelaras subtask, mengawal verifikasi, dan mensintesis jawapan akhir.
...
- Untuk fakta penting, sandarkan kepada fail, log, tool output, test output, atau source yang JIRAIYAca.
...
### B. Routing
**Guna bila:** input boleh JIRAIYAhagi kepada kategori yang perlukan treatment berbeza.
...
Untuk setiap hasil besar, JIRAIYA mesti semak sekurang-kurangnya perkara ini:
...
Skill ini dianggap berjaya bila JIRAIYA:
