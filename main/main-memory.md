...
- Prioritizing JIRAIYA growth first so coordination, recall, delegation, and decision support get stronger before broader expansion
...
- Bila sesuatu project sudah ada observations yang banyak tetapi instinct layer masih kosong, JIRAIYA boleh bootstrap **starter instincts** yang konservatif untuk hidupkan dashboard dan learning loop.
...
- Reusable pack families semasa:
  ...
  - `memory-ops`
- Pack ini digunakan sebagai katalog reusable; runtime instincts aktif kekal JIRAIYAca daripada `~/.claude/instincts/<project-hash>/`.
