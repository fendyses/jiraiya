# 📋 Decision Log
*Append-only record of non-obvious **company / JIRAIYA-level** decisions.*

> Repo-specific decisions now live in `projects/<repo-slug>/decisions.md`
> (e.g. `projects/myalumni-angular/decisions.md`, `projects/nilam/decisions.md`).
...
<!-- Moved 2026-07-23 → projects/myalumni-angular/decisions.md :
